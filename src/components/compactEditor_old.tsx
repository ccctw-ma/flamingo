...
export default function CompactEditor(props: Porps) {
  ...
  const handleValueChange = (_: any, values: any) => {
    ...
    // Only validate errors and don't handle errors
    // form.validateFields().catch(handleError);
  };
      ...
      >
        ...
        {selectedType ===
          ...
          <Form.Item
            ...
            rules={[{ required: true, message: "Please input redirect" }]}
          >
            <Input.TextArea autoSize />
          </Form.Item>
        )}
