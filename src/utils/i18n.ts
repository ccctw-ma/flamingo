...
const messages = {
  en: {
    ...
    matchedRulesTooltip: "Matched rules within {minutes} minutes",
    ...
    recentMatchedRules: "Recent Matched Rules",
  ...
  "zh-CN": {
    ...
    saved: "已保存",
    savePending: "待保存",
    matchedRulesTooltip: "{minutes} 分钟内的命中规则",
